// Copyright 2014 Rahul Sharma. All rights reserved.
...
///
/// The [Txt] widget displays a string of text with single style. The string
...
/// {@tool snippet}
///
/// This example shows how to display text using the [Txt] widget with the
...
/// {@end-tool}
///
/// Using the [Text.rich] constructor, the [Txt] widget can
...
/// ## Interactivity
///
/// To make [Txt] react to touch events, wrap it in a [GestureDetector] widget
...
///  * [DefaultTextStyle], which sets default styles for [Txt] widgets.
class Txt extends StatelessWidget {
  ...
  ///
  /// ```dart
  /// Txt(r'$$', semanticsLabel: 'Double dollars')
  /// ```
  /// {@endtemplate}
